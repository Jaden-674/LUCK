...
if (isset($_GET["match_destroy"]) && $_GET["match_destroy"] == "true") {
  ...
  if (json_decode($matchDestroy->winner_uid)[0] != -1) { header("location: play.php"); }
...
?>
  ...
  <?php
// ip splash
    echo "<div id=\"en0_splashDisplay\">";
    echo "<h1>Connect At:".trim(shell_exec("ipconfig getifaddr en0"))."</h1>";
    echo "</div>";
  //lobby code start
